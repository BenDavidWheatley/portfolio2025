...
function About() {
    return (
        <section id='about' data-testid="about" className={Style.aboutContainer} >
            ...
            <a rel="noreferrer" href="mailto:info@wheatleystudios.com?subject=Project%20Inquiry&body=Hi%20there,%0D%0A%0D%0AI%20would%20like%20to%20discuss%20a%20new%20project..." 
   target="_blank"> Email: info@wheatleystudios.com</a>
        </section>
    )
}
